# About
This is my project for Codecademy's Appointment Planner in the Full Stack Engineer path. **Note** The initial commit includes default files provided by Codecademy (www.codecademy.com). I have built upon this starting point to develop the project further.
...
![Contact Page](./public/appointment-planner-1.png)
